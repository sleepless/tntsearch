...
class TNTGeoIndexer extends TNTIndexer
{
    public function createIndex($indexName)
    {
        ...
        $this->index->exec("CREATE TABLE IF NOT EXISTS " . $this->prefix . "locations (
            doc_id INTEGER,
            longitude REAL,
            latitude REAL,
            cos_lat REAL,
        ...
        $this->index->exec("CREATE INDEX location_index ON " . $this->prefix . "locations ('longitude', 'latitude');");

        $this->index->exec("CREATE TABLE IF NOT EXISTS " . $this->prefix . "info (key TEXT, value INTEGER)");
    ...
    public function prepareInsertStatement()
    {
        ...
        $this->insertStmt = $this->index->prepare("INSERT INTO " . $this->prefix . "locations (doc_id, longitude, latitude, cos_lat, sin_lat, cos_lng, sin_lng)
